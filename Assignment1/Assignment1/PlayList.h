...
//PRE: Checks and asks the user to re-enter a correct command.
//POST- returns a valid command
int selectComputation();

//PARAM: option- input command (1 or 2) , A- Playlist object
//PRE: only checks valid postion for input and removal of song from the playlist i.e. 1 and 2.
//POST: return the valid position
int validposition(const PlayList&, int);
